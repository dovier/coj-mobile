 ...
 * Use the {@link CountryStandingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CountryStandingFragment extends Fragment {
    ...
    public CountryStandingFragment() {
    ...
    public static CountryStandingFragment newInstance() {
        CountryStandingFragment fragment = new CountryStandingFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            adapter = new CountryStandingItem(new ArrayList<CountryRank>());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText(R.string.institution);
        ...
        recyclerView.setAdapter(new CountryStandingItem(new ArrayList<CountryRank>()));
    ...
    static class mAsyncTask extends AsyncTask<Integer, Void, List<CountryRank>> {
        ...
        @Override
        protected List<CountryRank> doInBackground(Integer... pages) {
        ...
        protected void onPostExecute(List<CountryRank> countryRanks) {
            ...
            if (localPage == 1 && !error){
                ...
                for (int i = 0; i < countryRanks.size(); i++) {
                    dataBaseManager.insertCountryRank(countryRanks.get(i));
                }
                dataBaseManager.closeDbConnections();
            }
