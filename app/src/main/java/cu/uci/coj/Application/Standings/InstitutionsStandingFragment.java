 ...
 * Use the {@link InstitutionsStandingFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InstitutionsStandingFragment extends Fragment {
    ...
    public InstitutionsStandingFragment() {
    ...
    public static InstitutionsStandingFragment newInstance() {
        InstitutionsStandingFragment fragment = new InstitutionsStandingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(new InstitutionStandingItem(new ArrayList<InstitutionRank>()));
        ...
        protected void onPostExecute(List<InstitutionRank> institutionRanks) {
            ...
            if (page == 1 && !error){
                ...
                for (int i = 0; i < institutionRanks.size(); i++) {
                    dataBaseManager.insertInstitutionRank(institutionRanks.get(i));
                }
                dataBaseManager.closeDbConnections();
            }
            ...
            if (institutionRanks.size() == 0 && !error){
                ...
                adapter.addAll(institutionRanks);
