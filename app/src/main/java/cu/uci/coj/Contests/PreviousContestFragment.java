 ...
 * Use the {@link PreviousContestFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PreviousContestFragment extends Fragment {
    ...
    public PreviousContestFragment() {
    ...
    public static PreviousContestFragment newInstance() {
        PreviousContestFragment fragment = new PreviousContestFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            recyclerView.setAdapter(adapter);
            new mAsyncTask(getActivity()).execute(Conexion.URL_CONTEST_PAST);
        }
    ...
    public class mAsyncTask extends AsyncTask<String, Void, List<Contest>> {
        ...
        protected List<Contest> doInBackground(String... urls) {
            ...
            try {
                ...
                try {
                    contests = dataBaseManager.getPreviousContest();
