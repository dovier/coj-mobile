 ...
 * Use the {@link ComingContestFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ComingContestFragment extends Fragment {
    ...
    public static ComingContestFragment newInstance() {
        ComingContestFragment fragment = new ComingContestFragment();
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            recyclerView.setAdapter(adapter);
            new mAsyncTask(getActivity()).execute(Conexion.URL_CONTEST_NEXT);
        }
    ...
    public class mAsyncTask extends AsyncTask<String, Void, List<Contest>> {
        ...
        protected void onCancelled() {
            ...
            snackbar.setAction(R.string.reload, new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new mAsyncTask(fragment_reference.get()).execute(Conexion.URL_CONTEST_NEXT);
                }
            });
            snackbar.show();
        ...
        protected List<Contest> doInBackground(String... urls) {
            ...
            try {
                ...
                try {
                    contests = dataBaseManager.getComingContest();
        ...
        protected void onPostExecute(List<Contest> contests) {
            ...
            if (network){
                DataBaseManager dataBaseManager = DataBaseManager.getInstance(fragment_reference.get().getApplicationContext());
                dataBaseManager.deleteAllComingContest();
                for (int i = 0; i < contests.size(); i++) {
                    dataBaseManager.insertComingContest(contests.get(i));
                }
                dataBaseManager.closeDbConnections();
            }
            if (contests.size() == 0){
